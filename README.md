...
Product revenue uses the user-supplied editable 80% CreditFresh / 20% MoneyKey allocation within both loan types. This allocation applies equally to opening CLAB and new lending. Loan-type pricing and credit assumptions remain shared across brands; changing the mix reallocates revenue without changing the combined forecast. Excel Assumptions E29 controls the CreditFresh share and E30 calculates the complement.
